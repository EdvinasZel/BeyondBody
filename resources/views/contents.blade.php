<div style="background: rgba(48, 174, 198, 0.05);" class="container pt-1 pb-2">

    <div class="row banner pb-3">
        ...
        <div class="col-6 banner-text-area">
            <img src="{{asset("storage/images/content.png")}}" alt="content" class="img-fluid">
        </div>
    </div>
